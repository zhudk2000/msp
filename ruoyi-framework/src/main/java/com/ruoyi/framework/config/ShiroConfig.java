...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        // 候选人答题和批改试卷查阅能力胜任模型
        filterChainDefinitionMap.put("/system/candidate/qa/detail/**", "anon");
        filterChainDefinitionMap.put("/system/position_quiz/**", "anon");
        filterChainDefinitionMap.put("/system/questions/**", "anon");
